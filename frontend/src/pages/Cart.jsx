    ...
    return products.length > 0 && cartItems ? (
        <div className="flex flex-col md:flex-row mt-16">
            <div className='flex-1 max-w-4xl'>
                ...
                <button onClick={() => { navigate('/products') }} className="group cursor-pointer flex items-center mt-8 gap-2 text-green-600 font-medium">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate('/add-address')} className="text-green-600 text-center cursor-pointer p-2 hover:bg-green-500/10">
                                    Add address
                                </p>
                            </div>
                        )}
