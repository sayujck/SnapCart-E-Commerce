                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e) => { e.stopPropagation(); }}>
                        {!cartItems[product._id] ? (
                            <button onClick={() => addToCart(product._id)} className="flex items-center justify-center gap-1 bg-green/10 border border-green/40 md:w-[80px] w-[64px] h-[34px] rounded text-green-600 cursor-pointer"  >
